...
from tests.random_refs import random_sku, random_batch_ref, random_order_id
...
def try_to_allocation(orderid, sku, exceptions):
...
def test_concurrent_updates_to_version_are_not_allowed(postgres_session_factory):
    ...
    exceptions = []
    try_to_allocate_order_1 = lambda: try_to_allocation(order1, sku, exceptions)
    try_to_allocate_order_2 = lambda: try_to_allocation(order2, sku, exceptions)
